...
%
% Modified by Matt 20/07/2012 to remove the plot of the function

function [fitlogsignal,ProbPerc,  p50, logsignal, n, p75, p84, chiSq, Rsq, D] = ProbitFit(signal, pcCorrect, numstim)
...
function [Grad, ICept] = FitStraightProbitLine(XAxis, YAxis)
    ...
    if IsOctave
      fittedParams = fminsearch(@LsError, [100 100], [],[],XAxis, YAxis); % was 0.1 0.1
    else
